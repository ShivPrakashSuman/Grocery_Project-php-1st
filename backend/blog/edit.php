            ...
            <div class="row mt-5 pt-2 mr-2">
                <div class="shadow-lg bg-light p-4">
                    <div class="text-primary col-sm-6 mt-2">
                        <h1 style="font-size:29px;"><b> Blog <i class="fa fa-stack-overflow ml-3"></i></b></h1>
                    </div>
                    <div class="col-sm-6 ">
                        <div class="float-right ">
                                ...
                                <div class="shadow-lg ">
                                        ...
                                        $id = $_GET['id'];
                                            if(!$id){
                                                ...
                                                if($result->num_rows > 0) {
                                                    ...
                                                    $sql1 = "select id,category_id from category_2 ";
                                                    $result1 = $comm->query($sql1); 
                                                    $category = []; 
                                                    if($result1->num_rows > 0){
                                                        while($rowData1 = $result1->fetch_assoc() ) {
                                                                $category[] = $rowData1; 
                                                            }
                                                        }
                                    ...
                                    <div class="row p-4">
                                        <form class= "form p-4" action="edit_store.php" method="post" enctype="multipart/form-data">
                                            ...
                                            <input type="text" class="form-control "  placeholder="Enter Title" name="title" style="font-size:18px;" value="<?php echo $rowData['title']; ?>" required > <br>

                                            <select class="form-control" name="category_id"  style="font-size:18px;" required>
                                               <?php foreach($category as $key=>$val){ ?>
                                                    <option value="<?php echo $val['id'] ?>"<?php if( $val['id'] == $rowData['category_id'] ): ?> selected="selected"<?php endif; ?>><?php echo $val['category_id'] ?></option>
                                                <?php } ?>
                                            </select> <br>
                                            ...
                                            <input type="file" class="form-control bor"  placeholder="Enter File" name="file" style="font-size:17px;" value="<?php echo $rowData['image']; ?>"> <br> 
                                                
                                            <?php 
                                                if($rowData['image']){
                                            ?>
                                                <img src="../../uploads/<?php echo $rowData['image']; ?>" width="150px" height="150px">
