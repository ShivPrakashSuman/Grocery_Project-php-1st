            ...
            <div class="row mt-5 pt-2 mr-2">
                <div class="shadow-lg bg-light p-4">
                    <div class="text-primary col-sm-6 mt-2">
                        <h1 style="font-size:29px;"><b> Employee Register Page <i class="fab fa-google-drive ml-3"></i></b></h1>
                    </div>
                    <div class="col-sm-6 ">
                        <div class="float-right ">
                            <div class="float-left text-primary ">
                                <a href="#">
                                    <h1 style="font-size:22px;" class="btn btn-primary mr-2"><b><i class="fa fa-cart-plus mr-2 ml-2 " style="font-size: 25px;"></i></b></h1>
                                </a>
                            </div>
            ...
            <div class="row text-muted mt-5 pt-5">
                ...
                ?>
                    <form action="" method="get">
                        ...
                        <a href="http://localhost/PHP_Work/Grocery_Project_in_PHP/backend/layout/table.php" class=" ico2 btn-muted"> Reset</a>
                    </form>
                <?php }  else { ?>
                    <form action="" method="get">
                        <input type="text" name="search" class="form-control" id="search2" placeholder="Search...." value="">
                        <button type="submit"  class="ico1 btn-primary"> search.. <i class="fa fa-search fa-sm"></i> </button>
                        <a href="http://localhost/PHP_Work/Grocery_Project_in_PHP/backend/layout/table.php" class=" ico2 btn-muted"> Reset</a>
                    </form>
                <?php } ?>    
        ...
        <!--User Settings      -->    
            <div class="row">
                <div col-sm-12>
                    <?php 
                        include('../../include/db.php');
                        $sql = "select*from register_2";
                            if(isset($_GET['search'])){
                                $search = $_GET['search'];
                                $sql = "SELECT * FROM register_2 where fname LIKE '%$search%' or lname LIKE '%$search%' or email LIKE '%$search%' ";
                            }
